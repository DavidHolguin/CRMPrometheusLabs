...
BEGIN
  ...
  CASE p_agrupar_por
    WHEN \hora\ THEN v_formato_fecha := \YYYY-MM-DD
HH24:00\;
    WHEN \dia\ THEN v_formato_fecha := \YYYY-MM-DD\;
    WHEN \semana\ THEN v_formato_fecha := \YYYY-WIW\;
    WHEN \mes\ THEN v_formato_fecha := \YYYY-MM\;
    WHEN \trimestre\ THEN v_formato_fecha := \YYYY-QQ\;
