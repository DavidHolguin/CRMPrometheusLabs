              ...
              <SheetTrigger asChild>
                <Card className="p-6 cursor-pointer hover:bg-accent transition-colors">
                  <div className="flex items-start space-x-4">
                    <div className={`rounded-lg p-2 bg-background ${type.color}`}>
                ...
                >
                  <div className="flex items-center space-x-4">
                    {sourceTypes.find(t => t.id === source.type)?.icon && (
                      <div className={`p-1.5 rounded-md ${sourceTypes.find(t => t.id === source.type)?.color}`}>
                        {React.createElement(sourceTypes.find(t => t.id === source.type)?.icon as any, {
                          className: "h-4 w-4"
                        })}
                      </div>
                    )}
